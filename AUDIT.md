...
| Reproducibility | P2 (resolved) | CI pipeline was previously missing; now configured | `.github/workflows/ci.yml` | Expand incremental gates to full-repo over time | 0.5 day |
