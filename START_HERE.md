...
- Cycle-8 robust queue has completed routed stage (`b0`, `r1`, `r2`, `r3`, `r4`) and assignment `a1`/`a2`; assignment `a3` is currently training.
- Cycle-9 novelty queue (with supervised-proxy assignment objective) is waiting behind cycle-8.
...
2. Read `docs/evidence/cycle8_cycle9_live_snapshot_20260217T1334Z/monitoring_summary.md`.
