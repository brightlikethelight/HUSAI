...
| Phase 2 deep analysis (matching, geometry, known-circuit recovery) | Recover known structure above random controls | partial but improved | post-fix known-circuit rerun evaluates 20 checkpoints |
...
2. Complete assignment-aware external track with dimension-compatible setup.
